...
export default function MessageSender({chat}: {chat: chatProp}) {
    return (
        <div className="flex gap-2 mx-4 my-5">
            <Avatar img={chat.sender.image} />
            <div className="rounded-tl-none rounded-r-xl rounded-b-xl rounded-l-xl bg-white max-w-72 sm:max-w-96 px-4 py-2 shadow-md ">
